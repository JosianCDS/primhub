...
class CustomBarChart extends StatefulWidget {
  ...
  const CustomBarChart({super.key, required this.labels, required this.values, required this.colors, this.maxWidth = 1000.0});
          ...
          child: SizedBox.expand(
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                return CustomPaint(
                  painter: BarChartPainter(labels: widget.labels, values: widget.values, colors: widget.colors, axisColor: Theme.of(context).colorScheme.onSurface, gridColor: Theme.of(context).colorScheme.outlineVariant, textColor: Theme.of(context).colorScheme.onSurfaceVariant, touchPosition: _touchPosition, animationValue: _animation!.value),
                );
              },
            ),
          ),
...
class CustomDonutChart extends StatefulWidget {
  ...
  const CustomDonutChart({super.key, required this.values, required this.colors, this.maxWidth = 300.0});
        ...
        child: GestureDetector(
          ...
          child: SizedBox.expand(
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                return CustomPaint(
                  painter: DonutChartPainter(values: widget.values, colors: widget.colors, touchPosition: _touchPosition, animationValue: _animation!.value),
                );
              },
            ),
          ),
